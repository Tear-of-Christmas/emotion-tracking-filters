...
def run_experiment():
    ...
    plt.plot(kalman, label='Kalman Filter', linewidth=2, color='orange', marker='o')
    plt.plot(bayesian, label='Bayesian Update', linewidth=2, color='purple', marker='s')
    plt.plot(moving_avg, label='Moving Average', linewidth=2, color='green', marker='^')
    plt.title("7-Day Emotion Tracking: Kalman vs Bayesian vs Moving Avg",fontsize=18)
    plt.xlabel("Time Step",fontsize=18)
    plt.ylabel("Emotion Score",fontsize=18)
